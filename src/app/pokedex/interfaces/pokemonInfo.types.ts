// To parse this data:
//
//   import { Convert, PokemonInfoResponse } from "./file";
//
//   const pokemonInfoResponse = Convert.toPokemonInfoResponse(json);
//
...
export class Convert {
    public static toPokemonInfoResponse(json: string): PokemonInfoResponse {
        return cast(JSON.parse(json), r("PokemonInfoResponse"));
    }

    public static pokemonInfoResponseToJson(value: PokemonInfoResponse): string {
        return JSON.stringify(uncast(value, r("PokemonInfoResponse")), null, 2);
    }
}
...
const typeMap: any = {
    ...
    "HeldItem": o([
        ...
        { json: "version_details", js: "version_details", typ: a(r("VersionDetail")) },
    ], false),
    "VersionDetail": o([
